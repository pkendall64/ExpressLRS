...
uint8_t ICACHE_RAM_ATTR GENERIC_CRC8::calc(const uint8_t data) const
{
    return crc8tab[data];
}

uint8_t ICACHE_RAM_ATTR GENERIC_CRC8::calc(const uint8_t *data, uint16_t len, uint8_t crc) const
{
    while (len--)
    {
