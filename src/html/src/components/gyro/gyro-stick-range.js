    ...
    render() {
        ...
        return html`
            <div class="gyro-stick-range-card ${this.showCopy ? 'gyro-stick-range-card--copy' : ''}">
                ...
                <div class="gyro-stick-range" aria-label=${`CH${this.channel}: input ${this.input} microseconds, center ${mid} microseconds${this.showEndpoints ? `, range ${min} to ${max} microseconds` : ''}`}>
