                        ...
                        <tr>
                            ...
                            <td>
                                <div class="gyro-row-actions">
                                    <button class="mui-btn mui-btn--small gyro-icon-button" type="button"
                                            aria-label=${`Edit CH${row.channel} mapping`} title="Edit mapping"
                                    ...
                                    <button class="mui-btn mui-btn--small gyro-icon-button" type="button"
                                            aria-label=${`Delete CH${row.channel} mapping`} title="Delete mapping"
                                            ?disabled=${this.channelFunctionSaving}
